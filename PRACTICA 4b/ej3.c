...
int main() {
	...
	//Definimos el tratamiento de las señales para el padre.
	//De esta manera reconocerá el primer envío de señal.
	...
	//RE-definimos el tratamiento de las señales, 
